...
public class LandingGearTest
{
    ...
    public void activateHardLandingConfigurationTest()
    {
        ...
        assertEquals(dummy.getNose().getWheel(0).getPressure(), 75.0, 0.01);
        assertEquals(dummy.getNose().getWheel(1).getPressure(), 75.0, 0.01);
        
        assertEquals(dummy.getLeft().getWheel(0).getPressure(), 75.0, 0.01);
        assertEquals(dummy.getLeft().getWheel(1).getPressure(), 75.0, 0.01);
        
        assertEquals(dummy.getRight().getWheel(0).getPressure(), 75.0, 0.01);
        assertEquals(dummy.getRight().getWheel(1).getPressure(), 75.0, 0.01);
    }
    ...
    public void adjustPressurePosTest()
    {
        ...
        assertEquals(dummy.getNose().getWheel(0).getPressure(), 100);
        assertEquals(dummy.getNose().getWheel(1).getPressure(), 100);
        assertEquals(dummy.getLeft().getWheel(0).getPressure(), 100);
        assertEquals(dummy.getLeft().getWheel(1).getPressure(), 100);
        assertEquals(dummy.getRight().getWheel(0).getPressure(), 100);
        assertEquals(dummy.getRight().getWheel(1).getPressure(), 100);
        
        dummy.adjustPressure(-50);
        assertEquals(dummy.getNose().getWheel(0).getPressure(), 50);
        assertEquals(dummy.getNose().getWheel(1).getPressure(), 50);
        assertEquals(dummy.getLeft().getWheel(0).getPressure(), 50);
        assertEquals(dummy.getLeft().getWheel(1).getPressure(), 50);
        assertEquals(dummy.getRight().getWheel(0).getPressure(), 50);
        assertEquals(dummy.getRight().getWheel(1).getPressure(), 50);
        ...
        assertEquals(dummy.getNose().getWheel(0).getPressure(), 80);
        assertEquals(dummy.getNose().getWheel(1).getPressure(), 80);
        assertEquals(dummy.getLeft().getWheel(0).getPressure(), 80);
        assertEquals(dummy.getLeft().getWheel(1).getPressure(), 80);
        assertEquals(dummy.getRight().getWheel(0).getPressure(), 80);
        assertEquals(dummy.getRight().getWheel(1).getPressure(), 80);
        
        dummy.adjustPressure(-30);
        assertEquals(dummy.getNose().getWheel(0).getPressure(), 56);
        assertEquals(dummy.getNose().getWheel(1).getPressure(), 56);
        assertEquals(dummy.getLeft().getWheel(0).getPressure(), 56);
        assertEquals(dummy.getLeft().getWheel(1).getPressure(), 56);
        assertEquals(dummy.getRight().getWheel(0).getPressure(), 56);
        assertEquals(dummy.getRight().getWheel(1).getPressure(), 56);
        
        dummy.adjustPressure(-100);
        assertEquals(dummy.getNose().getWheel(0).getPressure(), 0);
        assertEquals(dummy.getNose().getWheel(1).getPressure(), 0);
        assertEquals(dummy.getLeft().getWheel(0).getPressure(), 0);
        assertEquals(dummy.getLeft().getWheel(1).getPressure(), 0);
        assertEquals(dummy.getRight().getWheel(0).getPressure(), 0);
        assertEquals(dummy.getRight().getWheel(1).getPressure(), 0);
    }
