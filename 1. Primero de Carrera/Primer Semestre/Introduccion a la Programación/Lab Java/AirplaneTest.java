...
public class AirplaneTest
{
    ...
    public void flyTest()
    {
        Airplane dummy = new Airplane('A', 3.7, 0, 2, 3, -1, 1);
         
        assertEquals(true, dummy.fly());
        assertEquals(2.7, dummy.getFuel(), 0.01);
        assertEquals(1, dummy.getXPos());
        assertEquals(4, dummy.getYPos());
        
        assertEquals(true, dummy.fly());
        assertEquals(1.7, dummy.getFuel(), 0.01);
        assertEquals(0, dummy.getXPos());
        assertEquals(5, dummy.getYPos());
        
        assertEquals(true, dummy.fly());
        assertEquals(0.7, dummy.getFuel(), 0.01);
        assertEquals(0, dummy.getXPos());
        assertEquals(6, dummy.getYPos());
        
        assertEquals(false, dummy.fly());
        assertEquals(0.7, dummy.getFuel(), 0.01);
        assertEquals(0, dummy.getXPos());
        assertEquals(6, dummy.getYPos());
    }
